...
if press=='Page 1':
    ...
    st.info("Hello! I'm Nafisyah. Your **Web Developer**, Nice Meet You.")
    st.info("I am using this dataset  to analyze prediction on a patient is going to attended for the medical appointment.")
